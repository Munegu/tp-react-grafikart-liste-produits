    ...
    render () {
        ...
        return <div>
            <div className="form-group mb-0">
                <input type="text" value={filterText} className="form-control" placeholder="Rerchercher" onChange={this.handleFilterTextChange}/>
            </div>
...
class FilterableProductTable extends React.Component{
    ...
    onFilterTextChange={this.handleFilterTextChange} onStockChange={this.handleInStockChange} />  
